...
public class Program
{
    public static void Main()
    {
        ...
        static int ReadIntNumber(string inputMessage = "¬ведите целое число: ")
        {
            int number = 0;
            while (true)
            {
                ...
                if (int.TryParse(Console.ReadLine(), out number))
                    ...
                    Console.WriteLine("ќшибка! ¬ведите целое число.");
            }
        }

        // создание массива целых чисел со случайными значени€ми
        ...
        int size = ReadIntNumber("¬ведите количество элементов массива: ");
