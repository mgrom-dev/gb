...
- **docker pull ubuntu** - скачать образ, без разворачивания контейнера. Как видим, докер начал скачивать версию образа с тегом latest (последний доступный). Чтобы скачать ubuntu версии 18.04., нужно ввести: **docker pull ubuntu:18.04**
