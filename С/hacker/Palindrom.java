 ...
 * character in the instance variable.
 * Input Format
 * 
 ...
 * If your code is correctly written and is a palindrome, the locked stub code
 * will print ; otherwise, it will print
 * 
 * Sample Input
 * 
 * racecar
...
public class Palindrom {
    public static void main(String[] args) {
        try (Scanner scan = new Scanner(System.in)) {
            ...
            for (int i = 0, li = str.length - 1, len = li / 2 + (str.length % 2 == 0 ? 1 : 0); i < len && isPalindrome; i++, li--)
                if (str[i] != str[li]) isPalindrome = false;
            System.out.println("The word, " + String.valueOf(str) + (isPalindrome ? ", is a palindrome." : ", is not a palindrome."));
        }
    }
}
